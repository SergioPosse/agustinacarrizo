...
import { watchResize } from "svelte-watch-resize";
    ...
    const closeDescription = ()=>{
        ...
        <div class="over animate" bind:this={overRef}>
            ...
            <span>{works[selected].description}</span>
        </div>
        ...
        <div class="carousel" use:watchResize={resize}>
                        ...
                        <div class={animate? "first animationtesteo" : "first"} on:touchstart={(e)=>handleTouch(e)} on:touchmove={(e)=>{handleTouchMove(e)}}>
                                ...
                                <div class="first-menu fade">
                                    <div on:click={()=>{window.open(works[selected].giturl)}} class="git-over"><img  src="/images/git-over.png" alt="git"/><h4>Code</h4></div>
                        ...
                        <div class="next">
                            <img on:click={handleClickNext} src="/images/play.png" alt="previous" class="next-button"/>
                        </div>
    </div>    
<style>
.first-body{
